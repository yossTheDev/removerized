      ...
      <div className="pointer-events-none absolute z-20 h-screen w-screen">
        ...
        <div className="pointer-events-none flex h-screen w-screen">
          <div className="pointer-events-none flex w-full items-center p-4">
            {/* Image Settings */}
            <div className="pointer-events-auto h-fit max-h-full w-[21rem] overflow-y-auto overflow-x-hidden rounded-md bg-white p-4 backdrop-blur-3xl transition-all dark:bg-neutral-900/80">
